                                      ...
                                      var CardDiv = RowCol.Helpers.DivC("ibox float-e-margins paddingBottom");
                                      {
                                          ...
                                          var ContentDiv = CardDiv.Helpers.DivC("ibox-content");
                                          {
                                              var RowContentDiv = ContentDiv.Helpers.DivC("row");
                                              {
                                                  ...
                                                  {
                                                      var FormContent = MiddleColContentDiv.Helpers.With<MELib.Movies.Movie>(c => c.EditingUser);
                                                      {
                                                  ...
                                                  //    {
                                                  //        var CardDiv1 = AnotherCardDiv.Helpers.DivC("ibox-title");
                                                  //        {
                                                  //            CardTitleDiv.Helpers.HTML("<i class='ffa-lg fa-fw pull-left'></i>");
                                                  //            CardTitleDiv.Helpers.HTML().Heading5("Account Information");
                                                  //        }
                                                  //        var CardTsDiv = CardTitleDiv.Helpers.DivC("ibox-tools");
                                                  //        {
                                                  //            var aToolsTag = CardTitleToolsDiv.Helpers.HTMLTag("a");
                                                  //            aToolsTag.AddClass("collapse-link");
                                                  //            {
                                                  ...
                                                  //            {
                                                  //                var Row1 = ContentDiv.Helpers.DivC("row");
                                                  //                {
                                                  //                    var LeftColContentDiv1 = Row.Helpers.DivC("col-md-12 text-center");
                                                  //                    {
                                                  ...
                                                  //                        //var ProfileDiv2 = LeftColContentDiv.Helpers.With<MELib.RO.ROUser>(c => c.User);
                                                  //                        //{
                                                  //                        //    LeftColContentDiv.Helpers.HTML("FullName:");
                                                  //                        //    LeftColContentDiv.Helpers.Span(c => c.User.FirstName).Style.FontSize = "15px";

                                                  //                        //}
                                                  //                        LeftColContentDiv.Helpers.DivC("row");

                                                  //                        var profileTypeDiv = LeftColContentDiv.Helpers.With<MELib.AccountTypes.AccountTypes>(c => c.AccountTypes);
                                                  //                        {
                                                  //                            profileTypeDiv.Helpers.HTML("Account Type : ");
                                                  ...
                                                  //                            ProfileDiv.Helpers.HTML("Balance: R");
                                                  //                            ProfileDiv.Helpers.Span(c => c.Balance);
                                                  //                            ProfileDiv.Style.FontSize = " 150px";
                                                  //                        }
                                                  //                    }
                                                  //                }
                                                  //            }
