                                    ...
                                    var MiddleColRight = RowContentDiv.Helpers.DivC("col-md-8");
                                    {
                                        ...
                                        var AnotherCardDiv = MiddleColRight.Helpers.DivC("ibox float-e-margins paddingBottom");
                                        {
                                            var CardTitleDiv = AnotherCardDiv.Helpers.DivC("ibox-title");
                                            {
                                                ...
                                                CardTitleDiv.Helpers.HTML().Heading5("Movie Preview");
                                            }
                                            ...
                                            var ContentDiv = AnotherCardDiv.Helpers.DivC("ibox-content");
                                            {
                                                var MovieContentDiv = ContentDiv.Helpers.DivC("row");
                                                {
                                                    ...
                                                    {
                                                        var MovieDiv2 = MovieDiv.Helpers.With<MELib.Movies.Movie>(c => c.Movie);
                                                        {
                                                            //    MovieDiv2.Helpers.HTML("<h1>{  Movie Title }</h1>");
                                                            MovieDiv2.Helpers.Span(c => c.MovieTitle).Style.FontSize ="30px";
                                                            MovieDiv2.Helpers.DivC("row");
                                                            //    MovieDiv.Helpers.HTML("<h2>{ Movie Description }</h2>");
                                                            MovieDiv2.Helpers.Span(c => c.MovieDescription);
                                                            //MovieDiv2.Helpers.HTML("<h3>Preview</h3>");
                                                        }
                                                        // Place holder
