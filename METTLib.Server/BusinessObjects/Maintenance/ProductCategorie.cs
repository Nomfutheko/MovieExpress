...
namespace MELib.Maintenance
{
    ...
    public class ProductCategorie
     : SingularBusinessBase<ProductCategorie>
    {
        ...
        public override string ToString()
        {
            if (this.CategoryName.Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "Product Categorie");
                }
                else
                {
                    return String.Format("Blank {0}", "Product Categorie");
                }
            }
            else
            {
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewProductCategorie() method.
        }

        public static ProductCategorie NewProductCategorie()
        {
            return DataPortal.CreateChild<ProductCategorie>();
        }
        ...
        internal static ProductCategorie GetProductCategorie(SafeDataReader dr)
        {
            var p = new ProductCategorie();
            p.Fetch(dr);
            return p;
        }
