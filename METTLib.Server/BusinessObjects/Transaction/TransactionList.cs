...
namespace MELib.Transaction
{
     ...
     : MEBusinessListBase<TransactionList, Transaction>
    {
        ...
        public static TransactionList GetTransactionList(int UserID , int TransactionTypeID)
        {
            return DataPortal.Fetch<TransactionList>(new Criteria() { UserID = UserID, TransactionTypeID = TransactionTypeID });
        }
