     ...
     : MEBusinessBase<AccountTypes>
    {
        ...
        public override string ToString()
        {
            if (this.AccountType.Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "Account Types");
                }
                else
                {
                    return String.Format("Blank {0}", "Account Types");
                }
            }
            else
            {
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewAccountTypes() method.
        }

        public static AccountTypes NewAccountTypes()
        {
            return DataPortal.CreateChild<AccountTypes>();
        }
        ...
        internal static AccountTypes GetAccountTypes(SafeDataReader dr)
        {
            var a = new AccountTypes();
            a.Fetch(dr);
            return a;
        }
